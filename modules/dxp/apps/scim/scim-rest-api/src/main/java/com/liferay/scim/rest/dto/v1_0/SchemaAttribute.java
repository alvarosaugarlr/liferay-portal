...
public class SchemaAttribute implements Serializable {
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected SchemaAttribute subAttributes;

	@JsonIgnore
	private Supplier<SchemaAttribute> _subAttributesSupplier;
	...
	public String toString() {
		...
		if (canonicalValues != null) {
			...
			sb.append(_escape(canonicalValues));
		...
		SchemaAttribute subAttributes = getSubAttributes();
		...
		if (subAttributes != null) {
			...
			sb.append(String.valueOf(subAttributes));
		}
