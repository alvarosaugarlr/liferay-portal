...
public class ForceReconsentMVCResourceCommandTest {
	...
	public void testServeResourceWithBlockedRequest() throws Exception {
		...
		// A POST carrying an invalid token
		...
		// A POST carrying a valid token and an unrecognized scope
	...
	private MockLiferayResourceRequest _getMockLiferayResourceRequest(
		...
		// An authenticated administrator always has a CSRF token in the
		// session. A cross site request reaches the endpoint with that ambient
		// session but never with the token.
